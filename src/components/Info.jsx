  ...
  return (
    <div className="info--container">
      ...
      <div className="card">
        ...
        <p className="b--ads">Develop skills you can apply right away, with curated e-learning courses designed by <span>BYOI</span> experts. Learn at your own pace and get certified.</p>

        <a className="join--button" href="https://t.me/+oCeVAiPJM482NjI0" rel="noreferrer" target="_blank">Join us today<img src={message} alt="" className="icon" /></a>
      </div>
